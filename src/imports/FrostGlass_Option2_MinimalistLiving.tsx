...
import bgImage from 'figma:asset/83b7010380064eb924f12f2c31d12897db780cbf.png';

export default function FrostGlass_Option2_MinimalistLiving() {
  return (
    <div className="w-full min-h-screen relative flex items-center justify-center overflow-hidden" style={{
      // DOUBLE HEIGHT LUXURY - Snow outside, warm lighting
